          ...
          <Dialog.Content className='fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg max-w-lg shadow-black/25'>
            ...
            >
              ...
              <footer className='mt-4 flex justify-end items-center gap-4'>
                <Dialog.Close 
                  className='bg-zinc-500 px-5 h-12 rounded-md font-semibold hover:bg-zinc-600 transition duration-500'
                >
                  Cancelar
                </Dialog.Close >
                <button 
                  type='submit'
                  className='flex items-center bg-violet-500 px-5 h-12 rounded-md font-semibold gap-3 hover:bg-violet-700 transtion duration-500'
                >
